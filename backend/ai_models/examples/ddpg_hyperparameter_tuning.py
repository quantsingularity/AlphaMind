...
def generate_sample_market_data(n_assets=3, n_days=252, seed=42):
    ...
    prices['Asset3'] = 100 + 10*np.sin(t) + np.cumsum(np.random.normal(0, 0.01, n_days))
...
def create_environment(data=None, window_size=10, transaction_cost=0.001, max_steps=252):
    """
...
def run_hyperparameter_tuning(param_grid=None, n_trials=20, episodes_per_trial=5, max_steps=100):
    """
