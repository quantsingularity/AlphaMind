...
class TestEnhancedVenueAdapter(unittest.TestCase):
    ...
    def test_health_check(self):
        ...
        # Simulate timeout
        self.adapter.last_activity_time = datetime.datetime.now() - datetime.timedelta(seconds=120)
        is_healthy = self.adapter._check_connection_health()
...
class TestEnhancedMarketConnectivityManager(unittest.TestCase):
    ...
    def test_connect_all_venues(self):
        ...
        self.assertEqual(self.manager.venues["venue1"].status, ConnectionStatus.CONNECTED)
        self.assertEqual(self.manager.venues["venue2"].status, ConnectionStatus.CONNECTED)
    ...
    def test_simulate_venue_failure(self):
        ...
        self.manager.venues["venue1"].reconnection_manager.connection_lost = lambda: None
        ...
        self.assertEqual(self.manager.venues["venue1"].last_error, "Simulated complete failure")
    ...
    def test_simulate_market_data_issue(self):
        ...
        success = self.manager.simulate_market_data_issue(
            venue_id="venue1",
            issue_type=FailureMode.DATA_CORRUPTION
        )
        self.assertTrue(success)
        ...
        self.assertTrue(self.manager.venues["venue1"].failure_simulation_enabled)
        self.assertEqual(
            self.manager.venues["venue1"].failure_probabilities[FailureMode.DATA_CORRUPTION],
            1.0
        )
