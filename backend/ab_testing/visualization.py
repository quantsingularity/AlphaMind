...
#                 0.5,
#                 0.5,
#                 f"Visualization not implemented for {test_type}",
#                 ha="center",
#                 va="center",
#                 transform=ax.transAxes,
            )
...
#     def _plot_mann_whitney_results(self, test_results: Dict, ax: Axes) -> None:
#        """"""
...
#             else "Medium" if abs(effect_size) < 0.5 else "Large"
        )
#         ax.text(
#             0.5,
#             0.85,
#             f"Effect Size: {effect_size:.4f} ({effect_size_text})",
#             ha="center",
#             va="top",
#             transform=ax.transAxes,
#             bbox=dict(boxstyle="round", alpha=0.1),
...
#     def _plot_bayesian_results(self, test_results: Dict, ax: Axes) -> None:
#        """"""
...
#             0.5,
#             0.7,
#             f"95% Credible Interval: [{ci_lower:.4f}, {ci_upper:.4f}]",
#             ha="center",
#             va="top",
#             transform=ax.transAxes,
#             bbox=dict(boxstyle="round", alpha=0.1),
...
#             0.5,
#             0.9,
#             f"Probability: {prob_improvement:.4f} ({sig_text})",
#             ha="center",
#             va="top",
#             transform=ax.transAxes,
#             bbox=dict(
...
#                 elif plot_type == "violin":
#                     sns.violinplot(
#                         x=variant_col, y=value_col, data=metric_df, ax=ax, inner="point"
                    )
#                 else:
#                     raise ValueError(f"Unsupported plot type: {plot_type}")
