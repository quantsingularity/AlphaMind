...
class ExperimentConfig:
    ...
    def add_segment_filter(self, name: str, filter_expression: str) -> None:
        """
    ...
    def clone(
        self, new_name: Optional[str] = None, new_description: Optional[str] = None
    ) -> "ExperimentConfig":
        """
...
class ExperimentConfigManager:
    ...
    def update_config(self, config: ExperimentConfig, save: bool = True) -> None:
        """
