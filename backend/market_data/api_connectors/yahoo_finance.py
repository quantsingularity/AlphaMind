...
class YahooFinanceConnector(APIConnector):
    ...
    def get_financial_statements(
        ...
        if self.using_rapid_api:
            ...
            if statement_type == "income":
                module = "incomeStatementHistory" if frequency == "annual" else "incomeStatementHistoryQuarterly"
            elif statement_type == "balance":
                module = "balanceSheetHistory" if frequency == "annual" else "balanceSheetHistoryQuarterly"
            elif statement_type == "cash":
                module = "cashflowStatementHistory" if frequency == "annual" else "cashflowStatementHistoryQuarterly"
            else:
                raise ValueError(f"Invalid statement type: {statement_type}")
