...
class TestOrderManager(unittest.TestCase):
    ...
    def test_validate_order(self):
        ...
        self.assertEqual(self.manager.orders[order.order_id].status, OrderStatus.VALIDATED)
    ...
    def test_validate_invalid_order(self):
        ...
        self.assertEqual(self.manager.orders[order.order_id].status, OrderStatus.REJECTED)
    ...
    def test_submit_order(self):
        ...
        self.assertTrue(result)
        self.assertEqual(self.manager.orders[order.order_id].status, OrderStatus.PENDING)
    ...
    def test_cancel_order(self):
        ...
        self.assertTrue(result)
        self.assertEqual(self.manager.orders[order.order_id].status, OrderStatus.CANCELLED)
    ...
    def test_add_fill(self):
        ...
        self.assertEqual(self.manager.orders[order.order_id].status, OrderStatus.PARTIALLY_FILLED)
