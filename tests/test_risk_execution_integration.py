...
from backend.risk_system.risk_aggregation.portfolio_risk import PortfolioRiskAggregator, PositionRisk
from backend.risk_system.risk_aggregation.position_limits import PositionLimitsManager, PositionLimit, LimitType, LimitScope
from backend.execution_engine.order_management.order_manager import OrderManager, Order, OrderSide, OrderType, OrderFill
...
class TestRiskExecutionIntegration(unittest.TestCase):
    ...
    def test_order_risk_check_integration(self):
        ...
        is_breached, severity = self.limits_manager.check_limit("AAPL_NOTIONAL", notional_value)
